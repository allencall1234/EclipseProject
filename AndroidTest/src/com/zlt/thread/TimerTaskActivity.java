...
public class TimerTaskActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.timertasklayout);
		mContext = this;
		mButton0 = (Button) this.findViewById(R.id.button11);
		mButton1 = (Button) this.findViewById(R.id.button21);
		mTextView = (TextView) this.findViewById(R.id.textview11);
